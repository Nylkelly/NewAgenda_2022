...
<div class="login-box">
  ...
  <div class="card">
    <div class="card-body login-card-body">
      ...
      <?php
        incluide_once('config/conexao.php');
        if(isset($_POST['btnlogin'])){
          $email=$_POST['email'];
          $senha=base64_encode($_POST['senha']);
          $select="SELECT * FROM tb_registro WHERE email_usuario=:emaillogin AND senha_usuario=:senhalogin";
          try {
            ...
            if ($verificar>0){
              ...
              echo "Vocẽ será redirecionado a sua agenda :)";
